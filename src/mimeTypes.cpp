...
namespace mimetypes {
const std::unordered_set<std::string> ARCHIVE_MIMES = {
    "application/zip",
...
const std::unordered_set<std::string> IMAGE_MIMES = {
    "image/jpeg",    "image/png", "image/gif",  "image/webp",
    "image/svg+xml", "image/bmp", "image/tiff",
};

const std::unordered_set<std::string> VIDEO_MIMES = {
    "video/mp4",   "video/x-matroska", "video/webm",
    "video/ogg",   "video/quicktime",  "video/x-msvideo",
    "video/x-flv", "video/mpeg",       "video/3gpp"
};

const std::unordered_set<std::string> AUDIO_MIMES = {
    "audio/mpeg", "audio/ogg", "audio/flac", "audio/wav", "audio/x-wav",
    "audio/webm", "audio/aac", "audio/mp4",  "audio/opus"
};
